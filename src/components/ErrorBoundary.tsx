        ...
        <div className="fixed inset-0 z-60 flex items-center justify-center p-4 bg-black/90">
          <div className="max-w-xl w-full bg-zinc-950 border border-red-900/30 rounded-lg p-6 text-center">
            ...
            <p className="text-sm text-zinc-400 mb-4">
              Um erro inesperado ocorreu ao abrir o painel. Os detalhes foram
              salvos localmente para análise.
            </p>
            ...
            <div className="flex justify-center gap-3">
              <button
                ...
                className="px-4 py-2 bg-gold-400 text-zinc-900 rounded font-bold"
              >
                Recarregar
              </button>
            </div>
